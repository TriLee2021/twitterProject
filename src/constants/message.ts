// lưu thông báo lỗi cho người dùng
export const USERS_MESSAGES = {
  ...
  EMAIL_VERIFY_TOKEN_IS_REQUIRED: 'Email is required',
  VERIFY_EMAIL_SUCCESS: 'Verified email successfully',
  EMAIL_ALREADY_VERIFIED_BEFORE: 'Email alredy verified before',
  ...
  //forgotPassword
  FORGOT_PASSWORD_TOKEN_IS_INCORRECT: 'Forgot password is incorrect',
